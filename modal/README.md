...
```bash
modal run modal/runtime/embodiedgen_v2_l40s.py::benchmark_split --profile auto
```
...
```bash
modal run modal/runtime/embodiedgen_v2_l40s.py::benchmark_split --profile cost_first
```
...
modal run modal/runtime/embodiedgen_v2_l40s.py::autoscale_policy_check --profile auto
...
modal run modal/runtime/embodiedgen_v2_l40s.py::benchmark_split --profile balanced
```
